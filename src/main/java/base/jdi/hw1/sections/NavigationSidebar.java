...
public class NavigationSidebar extends Section {
    ...
    @XPath(".//*[@ui='label' and contains(.,'Service')]") public WebElement service;
    ...
    @XPath(".//*[@ui='label' and contains(.,'Performance')]") public WebElement performance;
    @XPath(".//*[@ui='label' and contains(.,'Metals & Colors')]") public WebElement metalsColors;
    @XPath(".//*[@ui='label' and contains(.,'HTML 5')]") public WebElement hTML5;
    @XPath(".//*[@ui='label' and contains(.,'Bootstrap')]") public WebElement bootstrap;
